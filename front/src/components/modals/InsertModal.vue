...
export default {
  ...
  methods: {
    ...
    async boardInsert() {
      ...
      formData.append("boardTitle", this.title);
      formData.append("boardContent", this.CKEditor.getData());

      formData.append("boardClsf", this.$store.state.boardStore.boardClsf);
      // file upload
