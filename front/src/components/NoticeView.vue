          ...
          <div class="col-lg-12">
            <div class="inner-content">
              ...
              <div class="container">
                ...
                <button v-show="this.$store.state.loginStore.userClsf=='001'" class="btn btn-sm btn-primary" @click="showInsertModal">글쓰기</button>
...
export default {
  ...
  methods: {
    ...
    boardList() {
      ...
      this.$store.state.boardStore.boardClsf = "001";
      this.$store.dispatch("boardList", "001"); //자유게시판은 002 던지고 공지사항은 001 던지면됨
    },
    searchButton()
    {
